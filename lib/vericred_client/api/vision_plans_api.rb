...
module VericredClient
  class VisionPlansApi
    ...
    # @return [VisionPlanSearchResponse]
    def find_vision_plans(body, opts = {})
      data, _status_code, _headers = find_vision_plans_with_http_info(body, opts)
      return data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(VisionPlanSearchResponse, Fixnum, Hash)>] VisionPlanSearchResponse data, response status code and response headers
    def find_vision_plans_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VisionPlansApi.find_vision_plans ..."
      end
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling VisionPlansApi.find_vision_plans" if body.nil?
      # resource path
      local_var_path = "/plans/vision/search".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'VisionPlanSearchResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VisionPlansApi#find_vision_plans\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :year Plan year (defaults to current year)
    # @return [Array<(VisionPlanShowResponse, Fixnum, Hash)>] VisionPlanShowResponse data, response status code and response headers
    def show_medical_plan_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VisionPlansApi.show_medical_plan ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling VisionPlansApi.show_medical_plan" if id.nil?
      # resource path
      local_var_path = "/plans/vision/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VisionPlansApi#show_medical_plan\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end

...
module VericredClient
  class MedicalPlansApi
    ...
    def find_plans_with_http_info(body, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'body' when calling MedicalPlansApi.find_plans" if body.nil?
      # resource path
    ...
    def show_plan_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling MedicalPlansApi.show_plan" if id.nil?
      # resource path

...
module VericredClient
  class DentalPlansApi
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(DentalPlanSearchResponse, Fixnum, Hash)>] DentalPlanSearchResponse data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :year Plan year (defaults to current year)
    # @return [Array<(DentalPlanShowResponse, Fixnum, Hash)>] DentalPlanShowResponse data, response status code and response headers

...
module VericredClient
  class QuotingApi
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GroupCreateResponse, Fixnum, Hash)>] GroupCreateResponse data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [QuoteCreateRequest] :body 
    # @return [Array<(QuoteCreateResponse, Fixnum, Hash)>] QuoteCreateResponse data, response status code and response headers
    ...
    # @param id ID of the Group
    # @param [Hash] opts the optional parameters
    # @return [Array<(GroupShowResponse, Fixnum, Hash)>] GroupShowResponse data, response status code and response headers

...
module VericredClient
  ...
  class IssuerRequest
    ...
    attr_accessor :carrier_vericred_id
    ...
    def hash
      [issuer_id_type, issuer_id, name, carrier_vericred_id, address_line_1, address_line_2, state_code, city, zip_code, licensed_state_code, brand_name, source_logo_url].hash
    end

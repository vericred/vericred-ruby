...
module VericredClient
  ...
  class DependentCreate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'same_household')
        self.same_household = attributes[:'same_household']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          same_household == o.same_household
    end
    ...
    def hash
      [date_of_birth, gender, last_used_tobacco, relationship, same_household].hash
    end

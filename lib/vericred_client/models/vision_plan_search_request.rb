...
module VericredClient
  ...
  class VisionPlanSearchRequest
    ...
    # The audience of plan to search for. Possible values are individual, shop, small_group, medicare_advantage
    ...
    def self.swagger_types
      {
        :'applicants' => :'Array<VisionPlanSearchApplicant>',
    ...
    def hash
      [applicants, enrollment_date, fips_code, issuer_id, market, page, per_page, zip_code].hash
    end

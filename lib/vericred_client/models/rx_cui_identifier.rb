...
module VericredClient
  ...
  class RxCuiIdentifier
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rx_cui_id')
        self.rx_cui_id = attributes[:'rx_cui_id']
      end

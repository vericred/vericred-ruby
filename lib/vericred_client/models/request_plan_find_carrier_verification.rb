...
module VericredClient
  ...
  class RequestPlanFindCarrierVerification
    ...
    def hash
      [applicants, carrier_id, drug_packages, enrollment_date, fips_code, group_name, household_income, household_size, ids, issuer_vericred_ids, market, page, per_page, providers, sort, zip_code].hash
    end

...
module VericredClient
  ...
  class DentalPlanBenefits
    # Individual Deductible benefit string
    attr_accessor :individual_deductible

    # Family Deductible benefit string
    attr_accessor :family_deductible

    # Individual Annual Max benefit string
    attr_accessor :individual_annual_max
    ...
    attr_accessor :radiograph_bitewings

    # Radiograph - Other benefit string
    attr_accessor :radiograph_other

    # Fluoride Treatment benefit string
    attr_accessor :fluoride_treatment

    # Space Maintainers benefit string
    attr_accessor :space_maintainers

    # Prophylaxis Cleaning benefit string
    attr_accessor :prophylaxis_cleaning

    # Sealant benefit string
    attr_accessor :sealant
    ...
    attr_accessor :endodontics

    # Periodontics benefit string
    attr_accessor :periodontics

    # Orthodontics - Adult benefit string
    attr_accessor :orthodontics_adult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fillings_amalgram')
    ...
    def hash
      [individual_deductible, family_deductible, individual_annual_max, family_max_annual_max, individual_moop, family_moop, office_visits, radiograph_bitewings, radiograph_other, fluoride_treatment, space_maintainers, prophylaxis_cleaning, sealant, fillings_amalgram, fillings_composite, emergency_treatment, restorative, surgery_anesthesia, surgery_extraction, endodontics, periodontics, orthodontics_adult, orthodontics_child].hash
    end

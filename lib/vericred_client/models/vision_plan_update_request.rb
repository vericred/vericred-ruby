...
module VericredClient
  ...
  class VisionPlanUpdateRequest
    # Vision Plan
    attr_accessor :vision_plan
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vision_plan')
        self.vision_plan = attributes[:'vision_plan']
      end

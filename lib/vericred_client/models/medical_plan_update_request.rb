...
module VericredClient
  ...
  class MedicalPlanUpdateRequest
    # Medical Plan
    attr_accessor :medical_plan
    ...
    def self.swagger_types
      {
        :'medical_plan' => :'MedicalPlanUpdate'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'medical_plan')
        self.medical_plan = attributes[:'medical_plan']
      end

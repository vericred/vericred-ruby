...
module VericredClient
  ...
  class VisionPlanBenefits
    ...
    attr_accessor :progressive_lenses

    # UV Lenses benefit string
    attr_accessor :uv_lenses

    # Scratch-Resistant Coating benefit string
    attr_accessor :scratch_resistant_coating

    # Antireflective Coating benefit string
    attr_accessor :antireflective_coating

    # Photochromatic - Single Vision benefit string
    attr_accessor :photochromatic_single_vision

    # Photochromatic - Mutlifocal benefit string
    attr_accessor :photochromatic_multifocal

    # Polychromatic - Single Vision benefit string
    attr_accessor :polychromatic_single_vision

    # Polychromatic - Mutlifocal benefit string
    attr_accessor :polychromatic_multifocal

...
module VericredClient
  ...
  class MemberRateShow
    ...
    # null
    attr_accessor :member_premium

    # null
    attr_accessor :total_premium
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'member_external_id')
        self.member_external_id = attributes[:'member_external_id']
      end
      ...
      if attributes.has_key?(:'member_premium')
        self.member_premium = attributes[:'member_premium']
      end

      if attributes.has_key?(:'total_premium')
        self.total_premium = attributes[:'total_premium']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          member_external_id == o.member_external_id &&
          member_id == o.member_id &&
          member_premium == o.member_premium &&
    ...
    def hash
      [dependent_premium, id, member_external_id, member_id, member_premium, total_premium].hash
    end

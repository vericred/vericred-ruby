...
module VericredClient
  ...
  class GroupShow
    # null
    attr_accessor :chamber_association
    ...
    def self.attribute_map
      {
        :'chamber_association' => :'chamber_association',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chamber_association')
        self.chamber_association = attributes[:'chamber_association']
      end
      ...
      if attributes.has_key?(:'contact_phone')
      ...
      if attributes.has_key?(:'sic_code')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          chamber_association == o.chamber_association &&
    ...
    def hash
      [chamber_association, company_name, contact_email, contact_name, contact_phone, external_id, id, sic_code].hash
    end

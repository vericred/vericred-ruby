...
module VericredClient
  ...
  class RequestProvidersSearch
    ...
    # List of hios ids and contract codes
    ...
    def hash
      [accepts_insurance, ids, network_ids, page, per_page, plan_ids, polygon, radius, search_term, sort, sort_seed, type, zip_code].hash
    end

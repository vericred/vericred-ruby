...
module VericredClient
  ...
  class ProviderDetails
    ...
    def hash
      [city, email, gender, first_name, id, last_name, latitude, longitude, middle_name, network_ids, organization_name, personal_phone, phone, presentation_name, specialty, state, state_id, street_line_1, street_line_2, suffix, title, type, zip_code, npis, hios_ids].hash
    end

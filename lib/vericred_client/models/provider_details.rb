...
module VericredClient
  ...
  class ProviderDetails
    ...
    def hash
      [city, email, first_name, gender, hios_ids, id, last_name, latitude, longitude, middle_name, network_ids, networks, npis, organization_name, phone, presentation_name, specialty, state, state_id, street_line_1, street_line_2, suffix, title, type, zip_code].hash
    end

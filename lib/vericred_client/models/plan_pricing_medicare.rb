...
module VericredClient
  ...
  class PlanPricingMedicare
    ...
    attr_accessor :health_premium

    # Medicare Advantage drug premium
    attr_accessor :drug_premium
    ...
    def hash
      [effective_date, expiration_date, plan_id, rating_area_id, health_premium, drug_premium, premium_source, updated_at].hash
    end

...
module VericredClient
  ...
  class RequestRatesSearch
    # Date on which the plan is effective
    attr_accessor :enrollment_date

    # Fips code in which the plan is offered
    attr_accessor :fips_code

    # Zip code in which the plan is offered
    ...
    def hash
      [enrollment_date, fips_code, zip_code].hash
    end

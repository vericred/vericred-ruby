...
module VericredClient
  ...
  class RequestPlanFind
    ...
    def hash
      [applicants, carrier_id, drug_packages, enrollment_date, fips_code, group_name, household_income, household_size, ids, market, page, per_page, providers, sort, zip_code].hash
    end

...
module VericredClient
  ...
  class MemberRatesShowResponse
    # List of MemberRates
    attr_accessor :member_rates
    ...
    def self.swagger_types
      {
        :'member_rates' => :'Array<MemberRateShow>',
        :'meta' => :'Meta'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'member_rates')
        if (value = attributes[:'member_rates']).is_a?(Array)
          self.member_rates = value
        end
      end

...
module VericredClient
  ...
  class PlanMedicareBulk
    ...
    def hash
      [carrier_name, display_name, effective_date, expiration_date, identifiers, name, network_ids, network_size, plan_type, service_area_id, source, id, formulary_name, updated_at].hash
    end

...
# Unit tests for VericredClient::DentalPlanShowResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DentalPlanShowResponse' do
  before do
    # run before each test
    @instance = VericredClient::DentalPlanShowResponse.new
  end
  ...
  describe 'test an instance of DentalPlanShowResponse' do
    it 'should create an instact of DentalPlanShowResponse' do
      expect(@instance).to be_instance_of(VericredClient::DentalPlanShowResponse)
    end
  end

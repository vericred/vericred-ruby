...
# Unit tests for VericredClient::QuoteCreate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QuoteCreate' do
  before do
    # run before each test
    @instance = VericredClient::QuoteCreate.new
  end
  ...
  describe 'test an instance of QuoteCreate' do
    it 'should create an instact of QuoteCreate' do
      expect(@instance).to be_instance_of(VericredClient::QuoteCreate)
    end
  end

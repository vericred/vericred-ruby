...
# Unit tests for VericredClient::LocationShow
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocationShow' do
  before do
    # run before each test
    @instance = VericredClient::LocationShow.new
  end
  ...
  describe 'test an instance of LocationShow' do
    it 'should create an instact of LocationShow' do
      expect(@instance).to be_instance_of(VericredClient::LocationShow)
    end
  end

...
# Unit tests for VericredClient::RequestPlanFindCarrierVerification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestPlanFindCarrierVerification' do
  before do
    # run before each test
    @instance = VericredClient::RequestPlanFindCarrierVerification.new
  end
  ...
  describe 'test an instance of RequestPlanFindCarrierVerification' do
    it 'should create an instact of RequestPlanFindCarrierVerification' do
      expect(@instance).to be_instance_of(VericredClient::RequestPlanFindCarrierVerification)
    end
  end

...
# Unit tests for VericredClient::EmbargoRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmbargoRequest' do
  before do
    # run before each test
    @instance = VericredClient::EmbargoRequest.new
  end
  ...
  describe 'test an instance of EmbargoRequest' do
    it 'should create an instact of EmbargoRequest' do
      expect(@instance).to be_instance_of(VericredClient::EmbargoRequest)
    end
  end

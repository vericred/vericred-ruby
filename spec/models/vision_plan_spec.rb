...
# Unit tests for VericredClient::VisionPlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisionPlan' do
  before do
    # run before each test
    @instance = VericredClient::VisionPlan.new
  end
  ...
  describe 'test an instance of VisionPlan' do
    it 'should create an instact of VisionPlan' do
      expect(@instance).to be_instance_of(VericredClient::VisionPlan)
    end
  end

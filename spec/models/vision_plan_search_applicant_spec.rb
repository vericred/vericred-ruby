...
# Unit tests for VericredClient::VisionPlanSearchApplicant
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisionPlanSearchApplicant' do
  before do
    # run before each test
    @instance = VericredClient::VisionPlanSearchApplicant.new
  end
  ...
  describe 'test an instance of VisionPlanSearchApplicant' do
    it 'should create an instact of VisionPlanSearchApplicant' do
      expect(@instance).to be_instance_of(VericredClient::VisionPlanSearchApplicant)
    end
  end

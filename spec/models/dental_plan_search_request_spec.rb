...
# Unit tests for VericredClient::DentalPlanSearchRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DentalPlanSearchRequest' do
  before do
    # run before each test
    @instance = VericredClient::DentalPlanSearchRequest.new
  end
  ...
  describe 'test an instance of DentalPlanSearchRequest' do
    it 'should create an instact of DentalPlanSearchRequest' do
      expect(@instance).to be_instance_of(VericredClient::DentalPlanSearchRequest)
    end
  end

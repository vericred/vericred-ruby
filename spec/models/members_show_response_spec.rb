...
# Unit tests for VericredClient::MembersShowResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MembersShowResponse' do
  before do
    # run before each test
    @instance = VericredClient::MembersShowResponse.new
  end
  ...
  describe 'test an instance of MembersShowResponse' do
    it 'should create an instact of MembersShowResponse' do
      expect(@instance).to be_instance_of(VericredClient::MembersShowResponse)
    end
  end

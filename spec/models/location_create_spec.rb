...
# Unit tests for VericredClient::LocationCreate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocationCreate' do
  before do
    # run before each test
    @instance = VericredClient::LocationCreate.new
  end
  ...
  describe 'test an instance of LocationCreate' do
    it 'should create an instact of LocationCreate' do
      expect(@instance).to be_instance_of(VericredClient::LocationCreate)
    end
  end

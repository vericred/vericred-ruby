...
# Unit tests for VericredClient::MemberCreate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MemberCreate' do
  before do
    # run before each test
    @instance = VericredClient::MemberCreate.new
  end
  ...
  describe 'test an instance of MemberCreate' do
    it 'should create an instact of MemberCreate' do
      expect(@instance).to be_instance_of(VericredClient::MemberCreate)
    end
  end
  ...
  describe 'test attribute "retiree"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

...
# Unit tests for VericredClient::GroupShowResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupShowResponse' do
  before do
    # run before each test
    @instance = VericredClient::GroupShowResponse.new
  end
  ...
  describe 'test an instance of GroupShowResponse' do
    it 'should create an instact of GroupShowResponse' do
      expect(@instance).to be_instance_of(VericredClient::GroupShowResponse)
    end
  end

...
# Unit tests for VericredClient::ResponseRatesSearch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseRatesSearch' do
  before do
    # run before each test
    @instance = VericredClient::ResponseRatesSearch.new
  end
  ...
  describe 'test an instance of ResponseRatesSearch' do
    it 'should create an instact of ResponseRatesSearch' do
      expect(@instance).to be_instance_of(VericredClient::ResponseRatesSearch)
    end
  end

...
# Unit tests for VericredClient::VisionPlanSearchRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisionPlanSearchRequest' do
  before do
    # run before each test
    @instance = VericredClient::VisionPlanSearchRequest.new
  end
  ...
  describe 'test an instance of VisionPlanSearchRequest' do
    it 'should create an instact of VisionPlanSearchRequest' do
      expect(@instance).to be_instance_of(VericredClient::VisionPlanSearchRequest)
    end
  end

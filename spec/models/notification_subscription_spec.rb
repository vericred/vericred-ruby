...
# Unit tests for VericredClient::NotificationSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationSubscription' do
  before do
    # run before each test
    @instance = VericredClient::NotificationSubscription.new
  end
  ...
  describe 'test an instance of NotificationSubscription' do
    it 'should create an instact of NotificationSubscription' do
      expect(@instance).to be_instance_of(VericredClient::NotificationSubscription)
    end
  end

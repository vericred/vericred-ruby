...
# Unit tests for VericredClient::VisionPlanUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisionPlanUpdate' do
  before do
    # run before each test
    @instance = VericredClient::VisionPlanUpdate.new
  end
  ...
  describe 'test an instance of VisionPlanUpdate' do
    it 'should create an instact of VisionPlanUpdate' do
      expect(@instance).to be_instance_of(VericredClient::VisionPlanUpdate)
    end
  end

...
# Unit tests for VericredClient::NetworkComparisonRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NetworkComparisonRequest' do
  before do
    # run before each test
    @instance = VericredClient::NetworkComparisonRequest.new
  end
  ...
  describe 'test an instance of NetworkComparisonRequest' do
    it 'should create an instact of NetworkComparisonRequest' do
      expect(@instance).to be_instance_of(VericredClient::NetworkComparisonRequest)
    end
  end

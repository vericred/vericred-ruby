...
# Unit tests for VericredClient::RequestRatesSearch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestRatesSearch' do
  before do
    # run before each test
    @instance = VericredClient::RequestRatesSearch.new
  end
  ...
  describe 'test an instance of RequestRatesSearch' do
    it 'should create an instact of RequestRatesSearch' do
      expect(@instance).to be_instance_of(VericredClient::RequestRatesSearch)
    end
  end

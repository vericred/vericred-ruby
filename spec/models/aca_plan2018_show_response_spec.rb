...
# Unit tests for VericredClient::ACAPlan2018ShowResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ACAPlan2018ShowResponse' do
  before do
    # run before each test
    @instance = VericredClient::ACAPlan2018ShowResponse.new
  end
  ...
  describe 'test an instance of ACAPlan2018ShowResponse' do
    it 'should create an instact of ACAPlan2018ShowResponse' do
      expect(@instance).to be_instance_of(VericredClient::ACAPlan2018ShowResponse)
    end
  end

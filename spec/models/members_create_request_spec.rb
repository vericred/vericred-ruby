...
# Unit tests for VericredClient::MembersCreateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MembersCreateRequest' do
  before do
    # run before each test
    @instance = VericredClient::MembersCreateRequest.new
  end
  ...
  describe 'test an instance of MembersCreateRequest' do
    it 'should create an instact of MembersCreateRequest' do
      expect(@instance).to be_instance_of(VericredClient::MembersCreateRequest)
    end
  end

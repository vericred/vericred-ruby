...
# Unit tests for VericredClient::GroupCreateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupCreateRequest' do
  before do
    # run before each test
    @instance = VericredClient::GroupCreateRequest.new
  end
  ...
  describe 'test an instance of GroupCreateRequest' do
    it 'should create an instact of GroupCreateRequest' do
      expect(@instance).to be_instance_of(VericredClient::GroupCreateRequest)
    end
  end

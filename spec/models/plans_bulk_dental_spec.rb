...
# Unit tests for VericredClient::PlansBulkDental
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlansBulkDental' do
  before do
    # run before each test
    @instance = VericredClient::PlansBulkDental.new
  end
  ...
  describe 'test an instance of PlansBulkDental' do
    it 'should create an instact of PlansBulkDental' do
      expect(@instance).to be_instance_of(VericredClient::PlansBulkDental)
    end
  end
end

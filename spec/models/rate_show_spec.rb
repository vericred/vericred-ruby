...
# Unit tests for VericredClient::RateShow
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RateShow' do
  before do
    # run before each test
    @instance = VericredClient::RateShow.new
  end
  ...
  describe 'test an instance of RateShow' do
    it 'should create an instact of RateShow' do
      expect(@instance).to be_instance_of(VericredClient::RateShow)
    end
  end

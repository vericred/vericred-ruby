...
# Unit tests for VericredClient::CarrierRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CarrierRequest' do
  before do
    # run before each test
    @instance = VericredClient::CarrierRequest.new
  end
  ...
  describe 'test an instance of CarrierRequest' do
    it 'should create an instact of CarrierRequest' do
      expect(@instance).to be_instance_of(VericredClient::CarrierRequest)
    end
  end
  describe 'test attribute "carrier_group_vericred_id"' do
    it 'should work' do
  ...
  describe 'test attribute "carrier_id_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

...
# Unit tests for VericredClient::GroupShow
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupShow' do
  before do
    # run before each test
    @instance = VericredClient::GroupShow.new
  end
  ...
  describe 'test an instance of GroupShow' do
    it 'should create an instact of GroupShow' do
      expect(@instance).to be_instance_of(VericredClient::GroupShow)
    end
  end

...
# Unit tests for VericredClient::GroupCreateResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupCreateResponse' do
  before do
    # run before each test
    @instance = VericredClient::GroupCreateResponse.new
  end
  ...
  describe 'test an instance of GroupCreateResponse' do
    it 'should create an instact of GroupCreateResponse' do
      expect(@instance).to be_instance_of(VericredClient::GroupCreateResponse)
    end
  end

...
# Unit tests for VericredClient::DentalPlan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DentalPlan' do
  before do
    # run before each test
    @instance = VericredClient::DentalPlan.new
  end
  ...
  describe 'test an instance of DentalPlan' do
    it 'should create an instact of DentalPlan' do
      expect(@instance).to be_instance_of(VericredClient::DentalPlan)
    end
  end

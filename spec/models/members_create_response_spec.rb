...
# Unit tests for VericredClient::MembersCreateResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MembersCreateResponse' do
  before do
    # run before each test
    @instance = VericredClient::MembersCreateResponse.new
  end
  ...
  describe 'test an instance of MembersCreateResponse' do
    it 'should create an instact of MembersCreateResponse' do
      expect(@instance).to be_instance_of(VericredClient::MembersCreateResponse)
    end
  end

...
# Unit tests for VericredClient::PlansBulkACA2018
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlansBulkACA2018' do
  before do
    # run before each test
    @instance = VericredClient::PlansBulkACA2018.new
  end
  ...
  describe 'test an instance of PlansBulkACA2018' do
    it 'should create an instact of PlansBulkACA2018' do
      expect(@instance).to be_instance_of(VericredClient::PlansBulkACA2018)
    end
  end

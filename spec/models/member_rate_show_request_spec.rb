...
# Unit tests for VericredClient::MemberRateShowRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MemberRateShowRequest' do
  before do
    # run before each test
    @instance = VericredClient::MemberRateShowRequest.new
  end
  ...
  describe 'test an instance of MemberRateShowRequest' do
    it 'should create an instact of MemberRateShowRequest' do
      expect(@instance).to be_instance_of(VericredClient::MemberRateShowRequest)
    end
  end

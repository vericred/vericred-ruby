...
# Unit tests for VericredClient::PlansBulkVision
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlansBulkVision' do
  before do
    # run before each test
    @instance = VericredClient::PlansBulkVision.new
  end
  ...
  describe 'test an instance of PlansBulkVision' do
    it 'should create an instact of PlansBulkVision' do
      expect(@instance).to be_instance_of(VericredClient::PlansBulkVision)
    end
  end
end

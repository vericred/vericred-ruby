...
# Unit tests for VericredClient::LocationUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LocationUpdate' do
  before do
    # run before each test
    @instance = VericredClient::LocationUpdate.new
  end
  ...
  describe 'test an instance of LocationUpdate' do
    it 'should create an instact of LocationUpdate' do
      expect(@instance).to be_instance_of(VericredClient::LocationUpdate)
    end
  end

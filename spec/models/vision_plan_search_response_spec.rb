...
# Unit tests for VericredClient::VisionPlanSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisionPlanSearchResponse' do
  before do
    # run before each test
    @instance = VericredClient::VisionPlanSearchResponse.new
  end
  ...
  describe 'test an instance of VisionPlanSearchResponse' do
    it 'should create an instact of VisionPlanSearchResponse' do
      expect(@instance).to be_instance_of(VericredClient::VisionPlanSearchResponse)
    end
  end

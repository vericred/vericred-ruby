...
# Unit tests for VericredClient::RateShowRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RateShowRequest' do
  before do
    # run before each test
    @instance = VericredClient::RateShowRequest.new
  end
  ...
  describe 'test an instance of RateShowRequest' do
    it 'should create an instact of RateShowRequest' do
      expect(@instance).to be_instance_of(VericredClient::RateShowRequest)
    end
  end

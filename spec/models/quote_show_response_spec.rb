...
# Unit tests for VericredClient::QuoteShowResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QuoteShowResponse' do
  before do
    # run before each test
    @instance = VericredClient::QuoteShowResponse.new
  end
  ...
  describe 'test an instance of QuoteShowResponse' do
    it 'should create an instact of QuoteShowResponse' do
      expect(@instance).to be_instance_of(VericredClient::QuoteShowResponse)
    end
  end

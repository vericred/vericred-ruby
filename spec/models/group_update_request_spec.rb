...
# Unit tests for VericredClient::GroupUpdateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupUpdateRequest' do
  before do
    # run before each test
    @instance = VericredClient::GroupUpdateRequest.new
  end
  ...
  describe 'test an instance of GroupUpdateRequest' do
    it 'should create an instact of GroupUpdateRequest' do
      expect(@instance).to be_instance_of(VericredClient::GroupUpdateRequest)
    end
  end

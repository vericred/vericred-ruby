...
# Unit tests for VericredClient::VisionPlanShowResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisionPlanShowResponse' do
  before do
    # run before each test
    @instance = VericredClient::VisionPlanShowResponse.new
  end
  ...
  describe 'test an instance of VisionPlanShowResponse' do
    it 'should create an instact of VisionPlanShowResponse' do
      expect(@instance).to be_instance_of(VericredClient::VisionPlanShowResponse)
    end
  end

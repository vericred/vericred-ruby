...
# Unit tests for VericredClient::CarrierGroupRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CarrierGroupRequest' do
  before do
    # run before each test
    @instance = VericredClient::CarrierGroupRequest.new
  end
  ...
  describe 'test an instance of CarrierGroupRequest' do
    it 'should create an instact of CarrierGroupRequest' do
      expect(@instance).to be_instance_of(VericredClient::CarrierGroupRequest)
    end
  end
  ...
  describe 'test attribute "group_id_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

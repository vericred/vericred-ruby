...
# Unit tests for VericredClient::ProviderNetworks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProviderNetworks' do
  before do
    # run before each test
    @instance = VericredClient::ProviderNetworks.new
  end
  ...
  describe 'test an instance of ProviderNetworks' do
    it 'should create an instact of ProviderNetworks' do
      expect(@instance).to be_instance_of(VericredClient::ProviderNetworks)
    end
  end
  ...
  describe 'test attribute "pcp_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

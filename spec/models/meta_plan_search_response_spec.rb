...
# Unit tests for VericredClient::MetaPlanSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MetaPlanSearchResponse' do
  before do
    # run before each test
    @instance = VericredClient::MetaPlanSearchResponse.new
  end
  ...
  describe 'test an instance of MetaPlanSearchResponse' do
    it 'should create an instact of MetaPlanSearchResponse' do
      expect(@instance).to be_instance_of(VericredClient::MetaPlanSearchResponse)
    end
  end

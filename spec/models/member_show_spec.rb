...
# Unit tests for VericredClient::MemberShow
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MemberShow' do
  before do
    # run before each test
    @instance = VericredClient::MemberShow.new
  end
  ...
  describe 'test an instance of MemberShow' do
    it 'should create an instact of MemberShow' do
      expect(@instance).to be_instance_of(VericredClient::MemberShow)
    end
  end

...
# Unit tests for VericredClient::GroupCreate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupCreate' do
  before do
    # run before each test
    @instance = VericredClient::GroupCreate.new
  end
  ...
  describe 'test an instance of GroupCreate' do
    it 'should create an instact of GroupCreate' do
      expect(@instance).to be_instance_of(VericredClient::GroupCreate)
    end
  end

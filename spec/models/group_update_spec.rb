...
# Unit tests for VericredClient::GroupUpdate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GroupUpdate' do
  before do
    # run before each test
    @instance = VericredClient::GroupUpdate.new
  end
  ...
  describe 'test an instance of GroupUpdate' do
    it 'should create an instact of GroupUpdate' do
      expect(@instance).to be_instance_of(VericredClient::GroupUpdate)
    end
  end
  describe 'test attribute "chamber_association"' do
    it 'should work' do

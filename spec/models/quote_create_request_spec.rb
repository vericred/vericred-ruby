...
# Unit tests for VericredClient::QuoteCreateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QuoteCreateRequest' do
  before do
    # run before each test
    @instance = VericredClient::QuoteCreateRequest.new
  end
  ...
  describe 'test an instance of QuoteCreateRequest' do
    it 'should create an instact of QuoteCreateRequest' do
      expect(@instance).to be_instance_of(VericredClient::QuoteCreateRequest)
    end
  end

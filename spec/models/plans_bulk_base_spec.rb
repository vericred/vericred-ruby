...
# Unit tests for VericredClient::PlansBulkBase
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlansBulkBase' do
  before do
    # run before each test
    @instance = VericredClient::PlansBulkBase.new
  end
  ...
  describe 'test an instance of PlansBulkBase' do
    it 'should create an instact of PlansBulkBase' do
      expect(@instance).to be_instance_of(VericredClient::PlansBulkBase)
    end
  end
end

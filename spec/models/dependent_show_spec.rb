...
# Unit tests for VericredClient::DependentShow
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DependentShow' do
  before do
    # run before each test
    @instance = VericredClient::DependentShow.new
  end
  ...
  describe 'test an instance of DependentShow' do
    it 'should create an instact of DependentShow' do
      expect(@instance).to be_instance_of(VericredClient::DependentShow)
    end
  end

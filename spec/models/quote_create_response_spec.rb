...
# Unit tests for VericredClient::QuoteCreateResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QuoteCreateResponse' do
  before do
    # run before each test
    @instance = VericredClient::QuoteCreateResponse.new
  end
  ...
  describe 'test an instance of QuoteCreateResponse' do
    it 'should create an instact of QuoteCreateResponse' do
      expect(@instance).to be_instance_of(VericredClient::QuoteCreateResponse)
    end
  end

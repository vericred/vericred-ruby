...
# Unit tests for VericredClient::DentalPlanSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DentalPlanSearchResponse' do
  before do
    # run before each test
    @instance = VericredClient::DentalPlanSearchResponse.new
  end
  ...
  describe 'test an instance of DentalPlanSearchResponse' do
    it 'should create an instact of DentalPlanSearchResponse' do
      expect(@instance).to be_instance_of(VericredClient::DentalPlanSearchResponse)
    end
  end

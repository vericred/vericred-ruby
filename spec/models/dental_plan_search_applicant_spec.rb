...
# Unit tests for VericredClient::DentalPlanSearchApplicant
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DentalPlanSearchApplicant' do
  before do
    # run before each test
    @instance = VericredClient::DentalPlanSearchApplicant.new
  end
  ...
  describe 'test an instance of DentalPlanSearchApplicant' do
    it 'should create an instact of DentalPlanSearchApplicant' do
      expect(@instance).to be_instance_of(VericredClient::DentalPlanSearchApplicant)
    end
  end

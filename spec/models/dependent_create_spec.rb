...
# Unit tests for VericredClient::DependentCreate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DependentCreate' do
  before do
    # run before each test
    @instance = VericredClient::DependentCreate.new
  end
  ...
  describe 'test an instance of DependentCreate' do
    it 'should create an instact of DependentCreate' do
      expect(@instance).to be_instance_of(VericredClient::DependentCreate)
    end
  end

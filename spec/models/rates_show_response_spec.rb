...
# Unit tests for VericredClient::RatesShowResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RatesShowResponse' do
  before do
    # run before each test
    @instance = VericredClient::RatesShowResponse.new
  end
  ...
  describe 'test an instance of RatesShowResponse' do
    it 'should create an instact of RatesShowResponse' do
      expect(@instance).to be_instance_of(VericredClient::RatesShowResponse)
    end
  end

...
# Unit tests for VericredClient::PlanDeleted
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanDeleted' do
  before do
    # run before each test
    @instance = VericredClient::PlanDeleted.new
  end
  ...
  describe 'test an instance of PlanDeleted' do
    it 'should create an instact of PlanDeleted' do
      expect(@instance).to be_instance_of(VericredClient::PlanDeleted)
    end
  end
end

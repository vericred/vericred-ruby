...
# Unit tests for VericredClient::PlanIdentifier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlanIdentifier' do
  before do
    # run before each test
    @instance = VericredClient::PlanIdentifier.new
  end
  ...
  describe 'test an instance of PlanIdentifier' do
    it 'should create an instact of PlanIdentifier' do
      expect(@instance).to be_instance_of(VericredClient::PlanIdentifier)
    end
  end

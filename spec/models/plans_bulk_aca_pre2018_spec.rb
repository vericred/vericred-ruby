...
# Unit tests for VericredClient::PlansBulkACAPre2018
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlansBulkACAPre2018' do
  before do
    # run before each test
    @instance = VericredClient::PlansBulkACAPre2018.new
  end
  ...
  describe 'test an instance of PlansBulkACAPre2018' do
    it 'should create an instact of PlansBulkACAPre2018' do
      expect(@instance).to be_instance_of(VericredClient::PlansBulkACAPre2018)
    end
  end

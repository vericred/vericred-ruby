...
# Unit tests for VericredClient::MedicalPlansApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MedicalPlansApi' do
  before do
    # run before each test
    @instance = VericredClient::MedicalPlansApi.new
  end
  ...
  describe 'test an instance of MedicalPlansApi' do
    it 'should create an instact of MedicalPlansApi' do
      expect(@instance).to be_instance_of(VericredClient::MedicalPlansApi)
    end
  end

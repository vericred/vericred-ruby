...
# Unit tests for VericredClient::VisionPlansApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VisionPlansApi' do
  before do
    # run before each test
    @instance = VericredClient::VisionPlansApi.new
  end
  ...
  describe 'test an instance of VisionPlansApi' do
    it 'should create an instact of VisionPlansApi' do
      expect(@instance).to be_instance_of(VericredClient::VisionPlansApi)
    end
  end

  # unit tests for find_vision_plans
  # Search Plans
  ...
  describe 'find_vision_plans test' do
    it "should work" do

...
# Unit tests for VericredClient::MajorMedicalPlansApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MajorMedicalPlansApi' do
  before do
    # run before each test
    @instance = VericredClient::MajorMedicalPlansApi.new
  end
  ...
  describe 'test an instance of MajorMedicalPlansApi' do
    it 'should create an instact of MajorMedicalPlansApi' do
      expect(@instance).to be_instance_of(VericredClient::MajorMedicalPlansApi)
    end
  end

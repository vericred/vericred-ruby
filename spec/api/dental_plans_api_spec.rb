...
# Unit tests for VericredClient::DentalPlansApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DentalPlansApi' do
  before do
    # run before each test
    @instance = VericredClient::DentalPlansApi.new
  end
  ...
  describe 'test an instance of DentalPlansApi' do
    it 'should create an instact of DentalPlansApi' do
      expect(@instance).to be_instance_of(VericredClient::DentalPlansApi)
    end
  end

  # unit tests for find_dental_plans
  # Search Plans
  ...
  # @return [DentalPlanSearchResponse]
  describe 'find_dental_plans test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for show_dental_plan
  # Show Plan
  ...
  # @return [DentalPlanShowResponse]
  describe 'show_dental_plan test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
